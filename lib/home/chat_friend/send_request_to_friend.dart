    ...
    return Scaffold(
      body: StreamBuilder(
        stream: firestoreController.firestore
            ...
            .collection('send_request_to_friend').orderBy('time', descending: false)
            .snapshots(),
        builder: (context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot) {
          ...
          ) : const Center(child: Text("No requests have been sent yet!", style: TextStyle(fontSize: 16, color: Colors.grey),),);
        },
      ),
    );
  }
