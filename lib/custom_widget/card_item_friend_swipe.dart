...
class CardItemFriendSwipe extends StatelessWidget {
  ...
  final SlidableActionCallback? onPressedSwipe;
  final Color? backGroundSwipe;
  final IconData? iconSwipe;
    ...
    return Card(
      ...
      child: Slidable(
        endActionPane: ActionPane(
          motion: const StretchMotion(), // ScrollMotion()
          extentRatio: 0.5, // Tỷ lệ chiều rộng khi mở
          children: [
            SlidableAction(
              label: swipeLabel ?? "Delete",
              onPressed: onPressedSwipe,
              backgroundColor: backGroundSwipe ?? Colors.redAccent,
              icon: iconSwipe ?? Icons.delete_forever,
